    ...
    <>
      ...
      <main>
        ...
        <section className="relative overflow-hidden border-b-4 border-[var(--color-red)] bg-gradient-to-b from-[var(--color-navy)] to-[var(--color-navy-dark)]">
          <div className="pointer-events-none absolute inset-0 bg-[radial-gradient(ellipse_at_top,rgba(200,16,46,0.16),transparent_60%)]" />
          <div className="relative mx-auto max-w-[820px] px-5 py-16 sm:py-24 text-center [animation:heroTextReveal_0.9s_cubic-bezier(0.16,1,0.3,1)_both]">
            ...
            <p className="text-white/80 text-[16px] sm:text-[19px] leading-[1.6] max-w-[58ch] mx-auto mb-8">
              No corporate owners. No editorial board softening the truth. Just reporting that
              goes where the mainstream won&apos;t — straight to your inbox.
            </p>
            <a
              href="#join"
        ...
        {/* --- What you get --- */}
        <Reveal>
          <section className="mx-auto max-w-[1100px] px-5 py-14 sm:py-16">
            <div className="text-center mb-10">
              <h2 className="font-headline uppercase font-bold text-[26px] sm:text-[34px] tracking-[-0.02em] mb-3">
                What You Get
              </h2>
            ...
            <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-5 sm:gap-6">
              {BENEFITS.map((b) => (
                <div
                  key={b.title}
                  className="rounded-card border border-[var(--color-hairline)] shadow-card hover:shadow-card-hover bg-white p-5 transition"
                >
                  <div className="flex h-10 w-10 items-center justify-center rounded-full bg-[var(--color-red)]/10 mb-3.5">
        ...
        {/* --- Plan / join card --- */}
        <Reveal>
          <section id="join" className="mx-auto max-w-[560px] px-5 py-16 sm:py-20 scroll-mt-20">
            <div className="rounded-card border border-[var(--color-hairline)] shadow-card-hover bg-white overflow-hidden">
              <div className="bg-gradient-to-b from-[var(--color-navy)] to-[var(--color-navy-dark)] px-6 py-7 text-center">
        ...
        {/* --- FAQ --- */}
        <Reveal>
          <section className="mx-auto max-w-[720px] px-5 py-14 sm:py-16 border-t border-[var(--color-hairline)]">
            <h2 className="font-headline uppercase font-bold text-[24px] sm:text-[28px] tracking-[-0.02em] mb-7 text-center">
              Common Questions
            </h2>
