...
export default function SiteHeaderClient({ navCategories }: { navCategories: NavCategory[] }) {
  ...
  return (
    <>
      ...
      <MobileMenu open={menuOpen} onClose={() => setMenuOpen(false)} navCategories={navCategories} />
